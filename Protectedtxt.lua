...
function Library:Create(name,subname,keybind)
	...
	function Window:tab(tabname,showonstartup)
		...
		function pageitems:label(text)
                ...
                LabelText.Parent = PageContainer
                LabelText.BackgroundTransparency = 1.000 -- Torna o fundo completamente transparente
                LabelText.Position = UDim2.new(0.0137931034, 0, 0, 0)
                LabelText.Size = UDim2.new(0, 423, 0, 32)
                LabelText.Font = Enum.Font.Gotham
                LabelText.TextColor3 = Color3.fromRGB(255, 255, 255) -- Define a cor do texto como branca
    ...
    Toggle.BackgroundColor3 = Color3.fromRGB(25, 25, 25) -- Fundo principal do toggle
    ...
    Toggle_2.Position = UDim2.new(0.935, 0, 0.125, 0)
    Toggle_2.Size = UDim2.new(0, 24, 0, 24)
    Toggle_2.Image = "rbxassetid://10449228819"
    Toggle_2.ImageColor3 = Color3.fromRGB(0, 102, 255) -- Define a seta como azul (RGB para azul)
    Toggle_2.ImageTransparency = 1 -- Inicialmente transparente
    ...
    if toggled == true then
        ...
        Toggle_2.ImageColor3 = Color3.fromRGB(255, 255, 255) -- Seta branca quando ativada
    ...
    Button.MouseButton1Click:Connect(function()
        ...
        if toggled == true then
            Toggle_2.ImageTransparency = 0
            Toggle_2.ImageColor3 = Color3.fromRGB(255, 255, 255) -- Seta branca ao ativar
        elseif toggled == false then
            Toggle_2.ImageTransparency = 1
        end
